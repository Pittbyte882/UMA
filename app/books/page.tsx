...
const books = [
  {
    ...
    accent: "rose-gold",
    options: [
      { label: "Digital Edition", price: "$14.99", icon: Download, href: "#" },
      { label: "Physical Copy", price: "$24.99", icon: BookOpen, href: "#" },
    ],
  },
  {
    id: "kids",
    ...
    options: [
      { label: "Digital Edition", price: "$9.99", icon: Download, href: "#" },
      { label: "Physical Copy", price: "$19.99", icon: BookOpen, href: "#" },
    ],
  },
]
    ...
    <div className="min-h-screen bg-pearl-white">
      ...
      <main>
        ...
        <section className="relative pt-32 pb-20 overflow-hidden bg-gradient-to-b from-blush-pink/40 to-pearl-white">
          ...
          />
          <div className="absolute top-20 left-1/2 -translate-x-1/2 w-px h-16 opacity-30"
                ...
                >
                  ...
                  <div className="relative">
                    ...
                    >
                      ...
                      />
                      <span className="text-xs tracking-widest uppercase" style={{ color: "#B76E79" }}>
                        {book.tagline}
                      </span>
                    </div>
                    ...
                    <div className="space-y-3 mb-8">
                      <p className="text-xs uppercase tracking-[0.2em]" style={{ color: "#8A776B" }}>
                        Available As
                      </p>
                        ...
                        {book.options.map((option) => (
                          ...
                          >
                            <div className="flex items-center gap-3">
                              ...
                              >
                                <option.icon className="w-4 h-4" style={{ color: "#B76E79" }} />
                              </div>
                              <div>
                                <p className="text-sm font-medium" style={{ color: "#3D2B1F" }}>
                                  {option.label}
                                </p>
                                <p className="text-xs" style={{ color: "#8A776B" }}>
                                  {option.price}
                                </p>
                              </div>
                            </div>
        ...
        <section className="py-20 bg-gradient-to-b from-pearl-white to-blush-pink/30 relative">
          ...
          <div className="container mx-auto px-4 text-center">
            ...
            <p className="text-warm-taupe max-w-md mx-auto mb-8 text-sm md:text-base">
              Book a free consultation with Samantha and get a personalized recommendation for your vocal journey.
            </p>
            <Button
              asChild
