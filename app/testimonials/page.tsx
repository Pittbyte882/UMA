              ...
              <Card className="bg-gradient-to-br from-champagne-gold/10 to-rose-gold/10 border-champagne-gold/30">
                <CardContent className="p-8 md:p-12">
                  ...
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      <p className="font-serif text-xl text-espresso">Sarah Mitchell</p>
                  ...
                  <CardContent className="p-6">
                    <div className="flex items-center gap-4 mb-4">
                      ...
                      <div>
                        ...
                        <p className="text-warm-taupe text-sm">{testimonial.role}</p>
                      </div>
                    </div>
          ...
          <div className="container mx-auto px-4">
            <div className="text-center mb-16">
              ...
              <p className="text-warm-taupe text-lg max-w-2xl mx-auto">
                See the transformation in action through student recital highlights.
              </p>
            </div>
        ...
        <section className="py-16 bg-espresso text-pearl-white">
          <div className="container mx-auto px-4">
            <div className="grid grid-cols-2 md:grid-cols-4 gap-8 text-center">
              <div>
                <p className="font-serif text-4xl md:text-5xl text-champagne-gold mb-2">500+</p>
                <p className="text-pearl-white/70 text-sm">Students Taught</p>
              </div>
              <div>
                <p className="font-serif text-4xl md:text-5xl text-champagne-gold mb-2">15+</p>
                <p className="text-pearl-white/70 text-sm">Years Experience</p>
              </div>
              <div>
                <p className="font-serif text-4xl md:text-5xl text-champagne-gold mb-2">98%</p>
                <p className="text-pearl-white/70 text-sm">Would Recommend</p>
              </div>
              <div>
                <p className="font-serif text-4xl md:text-5xl text-champagne-gold mb-2">50+</p>
